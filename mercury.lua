...
edited by false, all credit goes to the developers mentioned above ^
]]
...
function Library:create(options)
	...
	settingsTab:keybind{
		Name = "Toggle Keybind",
		Description = "Key to hide/show the UI.",
	...
	settingsTab:toggle{
		Name = "Lock Dragging",
		Description = "Prevents the UI from going out of the window.",
		StartingState = true,
	...
	settingsTab:slider{
		Name = "UI Drag Speed",
		Description = "How fast the UI will drag across the screen.",
		Max = 20,
		Default = 14,
	...
	creditsTab:credit{Name = "false", Description = "Script Developer", Discord = "false#8060", V3rmillion = "falseopx"}
